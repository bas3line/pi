...
function generateFireworksModels(
	...
	writeFileSync(
		...
		`const catalog = ${JSON.stringify(catalog)};\n` +
			...
			`  if (url === "https://api.commandcode.ai/provider/v1/models") return Response.json({ data: [{ id: "claude-sonnet-5", name: "Claude Sonnet 5", context_length: 1000000, supported_endpoints: ["/messages"] }] });\n` +
